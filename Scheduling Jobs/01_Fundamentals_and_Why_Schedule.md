...
1. [What Is Job Scheduling?](#what-is-job-scheduling)
2. [Why Do We Schedule Jobs?](#why-do-we-schedule-jobs)
3. [How Does Linux Use Scheduling for Itself?](#how-does-linux-use-scheduling-for-itself)
4. [Key Vocabulary You Need to Know](#key-vocabulary-you-need-to-know)
   - [Daemon](#daemon)
   - [Script](#script)
   - [Execution Time](#execution-time)
   - [Job / Task](#job--task)
5. [The Tools Linux Gives You](#the-tools-linux-gives-you)
