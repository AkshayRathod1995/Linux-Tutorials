...
2. [Exercises 1-5: `at` and `batch`](#exercises-1-5-at-and-batch)
3. [Exercises 6-15: `cron` (Writing Specific Schedules)](#exercises-6-15-cron-writing-specific-schedules)
4. [Exercises 16-20: `anacron` and System Cron Directories](#exercises-16-20-anacron-and-system-cron-directories)
5. [Exercises 21-25: `systemd` Timers](#exercises-21-25-systemd-timers)
6. [Exercises 26-30: Troubleshooting and Log Checking](#exercises-26-30-troubleshooting-and-log-checking)
